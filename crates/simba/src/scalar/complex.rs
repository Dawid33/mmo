...
#[cfg(feature = "libm_force")]
impl ComplexField for ordered_float::OrderedFloat<f32> {
    type RealField = ordered_float::OrderedFloat<f32>;
    ...
    #[inline]
    fn norm1(self) -> Self::RealField {
        ordered_float::OrderedFloat(libm_force::fabsf(*self))
    }
    ...
    #[inline]
    fn recip(self) -> Self {
        ordered_float::OrderedFloat(f32::recip(*self))
    }
    ...
    #[inline]
    fn floor(self) -> Self {
        ordered_float::OrderedFloat(libm_force::floorf(*self))
    }

    #[inline]
    fn ceil(self) -> Self {
        ordered_float::OrderedFloat(libm_force::ceilf(*self))
    }

    #[inline]
    fn round(self) -> Self {
        ordered_float::OrderedFloat(libm_force::roundf(*self))
    }

    #[inline]
    fn trunc(self) -> Self {
        ordered_float::OrderedFloat(libm_force::truncf(*self))
    }

    #[inline]
    fn fract(self) -> Self {
        self - ordered_float::OrderedFloat(libm_force::truncf(*self))
    }
    ...
    #[inline]
    fn mul_add(self, a: Self, b: Self) -> Self {
        ordered_float::OrderedFloat(libm_force::fmaf(*self, *a, *b))
    }

    #[inline]
    fn powi(self, n: i32) -> Self {
        // TODO: implement a more accurate/efficient solution?
        ordered_float::OrderedFloat(libm_force::powf(*self, n as f32))
    }

    #[inline]
    fn powf(self, n: Self) -> Self {
        ordered_float::OrderedFloat(libm_force::powf(*self, *n))
    }
    ...
    #[inline]
    fn sqrt(self) -> Self {
        ordered_float::OrderedFloat(libm_force::sqrtf(*self))
    }

    #[inline]
    fn try_sqrt(self) -> Option<Self> {
        if self >= Self::zero() {
            Some(ordered_float::OrderedFloat(libm_force::sqrtf(*self)))
        } else {
            None
        }
    }
    ...
    #[inline]
    fn exp(self) -> Self {
        ordered_float::OrderedFloat(libm_force::expf(*self))
    }

    #[inline]
    fn exp2(self) -> Self {
        ordered_float::OrderedFloat(libm_force::exp2f(*self))
    }

    #[inline]
    fn exp_m1(self) -> Self {
        ordered_float::OrderedFloat(libm_force::expm1f(*self))
    }

    #[inline]
    fn ln_1p(self) -> Self {
        ordered_float::OrderedFloat(libm_force::log1pf(*self))
    }

    #[inline]
    fn ln(self) -> Self {
        ordered_float::OrderedFloat(libm_force::logf(*self))
    }

    #[inline]
    fn log(self, base: Self) -> Self {
        ordered_float::OrderedFloat(libm_force::logf(*self))
            / ordered_float::OrderedFloat(libm_force::logf(*base))
    }

    #[inline]
    fn log2(self) -> Self {
        ordered_float::OrderedFloat(libm_force::log2f(*self))
    }

    #[inline]
    fn log10(self) -> Self {
        ordered_float::OrderedFloat(libm_force::log10f(*self))
    }

    #[inline]
    fn cbrt(self) -> Self {
        ordered_float::OrderedFloat(libm_force::cbrtf(*self))
    }

    #[inline]
    fn hypot(self, other: Self) -> Self::RealField {
        ordered_float::OrderedFloat(libm_force::hypotf(*self, *other))
    }

    #[inline]
    fn sin(self) -> Self {
        ordered_float::OrderedFloat(libm_force::sinf(*self))
    }

    #[inline]
    fn cos(self) -> Self {
        ordered_float::OrderedFloat(libm_force::cosf(*self))
    }

    #[inline]
    fn tan(self) -> Self {
        ordered_float::OrderedFloat(libm_force::tanf(*self))
    }

    #[inline]
    fn asin(self) -> Self {
        ordered_float::OrderedFloat(libm_force::asinf(*self))
    }

    #[inline]
    fn acos(self) -> Self {
        ordered_float::OrderedFloat(libm_force::acosf(*self))
    }

    #[inline]
    fn atan(self) -> Self {
        ordered_float::OrderedFloat(libm_force::atanf(*self))
    }

    #[inline]
    fn sin_cos(self) -> (Self, Self) {
        let (a, b) = libm_force::sincosf(*self);
        (
            ordered_float::OrderedFloat(a),
            ordered_float::OrderedFloat(b),
        )
    }
    ...
    #[inline]
    fn sinh(self) -> Self {
        ordered_float::OrderedFloat(libm_force::sinhf(*self))
    }

    #[inline]
    fn cosh(self) -> Self {
        ordered_float::OrderedFloat(libm_force::coshf(*self))
    }

    #[inline]
    fn tanh(self) -> Self {
        ordered_float::OrderedFloat(libm_force::tanhf(*self))
    }

    #[inline]
    fn asinh(self) -> Self {
        ordered_float::OrderedFloat(libm_force::asinhf(*self))
    }

    #[inline]
    fn acosh(self) -> Self {
        ordered_float::OrderedFloat(libm_force::acoshf(*self))
    }

    #[inline]
    fn atanh(self) -> Self {
        ordered_float::OrderedFloat(libm_force::atanhf(*self))
    }
...
impl ComplexField for num_complex::Complex<f32> {
    type RealField = f32;
    ...
    #[inline]
    fn exp2(self) -> Self {
        let _2 = f32::one() + f32::one();
        num_complex::Complex::new(_2, f32::zero()).powc(self)
    }
    ...
    #[inline]
    fn log10(self) -> Self {
        let _10 = f32::from_subset(&10.0f64);
        self.log(_10)
    }

    #[inline]
    fn cbrt(self) -> Self {
        let one_third = f32::from_subset(&(1.0 / 3.0));
        self.powf(one_third)
    }
    ...
    fn powi(self, n: i32) -> Self {
        // TODO: is there a more accurate solution?
        let n = f32::from_subset(&(n as f64));
        self.powf(n)
    }
    ...
    */
    ...
    fn atan(self) -> Self {
        ...
        if self == i {
            return Self::new(f32::zero(), f32::one() / f32::zero());
    ...
    fn atanh(self) -> Self {
        ...
        let two = one.clone() + one.clone();
        if self == one {
            return Self::new(f32::one() / f32::zero(), f32::zero());
