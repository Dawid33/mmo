...
impl SubsetOf<OrderedFloat> for f32 {
    #[inline]
    ...
    #[inline]
    fn from_superset_unchecked(element: &OrderedFloat) -> f32 {
        **element
    }
...
impl SubsetOf<OrderedFloat> for f64 {
    #[inline]
    fn to_superset(&self) -> OrderedFloat {
    ...
    #[inline]
    fn from_superset_unchecked(element: &OrderedFloat) -> f64 {
        **element as f64
    }
...
impl SubsetOf<OrderedFloat> for OrderedFloat {
    ...
    #[inline]
    fn from_superset_unchecked(element: &OrderedFloat) -> OrderedFloat {
        *element
    }
