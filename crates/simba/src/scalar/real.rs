...
impl RealField for OrderedFloat {
    #[inline]
    fn is_sign_positive(&self) -> bool {
    ...
    #[inline(always)]
    fn copysign(self, sign: Self) -> Self {
        ordered_float::OrderedFloat(crate::scalar::real::libm_force_f32::copysign(*self, *sign))
    }
    ...
    #[inline]
    fn atan2(self, other: Self) -> Self {
        ordered_float::OrderedFloat(crate::scalar::real::libm_force_f32::atan2(*self, *other))
    }

    /// The smallest finite positive value representable using this type.
    #[inline]
    fn min_value() -> Option<Self> {
        Some(ordered_float::OrderedFloat(f32::MIN))
    }

    /// The largest finite positive value representable using this type.
    #[inline]
    fn max_value() -> Option<Self> {
        Some(ordered_float::OrderedFloat(f32::MAX))
    }

    /// Archimedes' constant.
    #[inline]
    fn pi() -> Self {
        ordered_float::OrderedFloat(f32::consts::PI)
    }

    /// 2.0 * pi.
    #[inline]
    fn two_pi() -> Self {
        ordered_float::OrderedFloat(f32::consts::PI + f32::consts::PI)
    }

    /// pi / 2.0.
    #[inline]
    fn frac_pi_2() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_PI_2)
    }

    /// pi / 3.0.
    #[inline]
    fn frac_pi_3() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_PI_3)
    }

    /// pi / 4.0.
    #[inline]
    fn frac_pi_4() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_PI_4)
    }

    /// pi / 6.0.
    #[inline]
    fn frac_pi_6() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_PI_6)
    }

    /// pi / 8.0.
    #[inline]
    fn frac_pi_8() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_PI_8)
    }

    /// 1.0 / pi.
    #[inline]
    fn frac_1_pi() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_1_PI)
    }

    /// 2.0 / pi.
    #[inline]
    fn frac_2_pi() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_2_PI)
    }

    /// 2.0 / sqrt(pi).
    #[inline]
    fn frac_2_sqrt_pi() -> Self {
        ordered_float::OrderedFloat(f32::consts::FRAC_2_SQRT_PI)
    }

    /// Euler's number.
    #[inline]
    fn e() -> Self {
        ordered_float::OrderedFloat(f32::consts::E)
    }

    /// log2(e).
    #[inline]
    fn log2_e() -> Self {
        ordered_float::OrderedFloat(f32::consts::LOG2_E)
    }

    /// log10(e).
    #[inline]
    fn log10_e() -> Self {
        ordered_float::OrderedFloat(f32::consts::LOG10_E)
    }

    /// ln(2.0).
    #[inline]
    fn ln_2() -> Self {
        ordered_float::OrderedFloat(f32::consts::LN_2)
    }

    /// ln(10.0).
    #[inline]
    fn ln_10() -> Self {
        ordered_float::OrderedFloat(f32::consts::LN_10)
    }
}
