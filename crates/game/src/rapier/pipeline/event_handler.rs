...
use crate::rapier::geometry::{ColliderSet, CollisionEvent, ContactForceEvent, ContactPair};
...
pub trait EventHandler: Send + Sync {
    ...
    /// [`Collider::contact_force_event_threshold`](crate::rapier::geometry::Collider::set_contact_force_event_threshold).
