...
use crate::rapier::dynamics::{ImpulseJointSet, IntegrationParameters, MultibodyJointSet};
...
///
/// **For full physics**, use [`PhysicsPipeline`](crate::rapier::pipeline::PhysicsPipeline) instead which includes this internally.
///
/// ## Use cases
///
