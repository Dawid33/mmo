...
use crate::rapier::geometry::{ColliderHandle, ColliderSet, ContactManifold, SolverContact, SolverFlags};
...
bitflags::bitflags! {
    ...
    /// use [`InteractionGroups`](crate::rapier::geometry::InteractionGroups) for collision filtering instead.
    ///
    /// Hooks let you:
