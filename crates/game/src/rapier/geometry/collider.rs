...
/// [`RigidBody`](crate::rapier::dynamics::RigidBody) handles the physics (mass, velocity, forces),
...
impl Collider {
    ...
    ///
    /// Hooks allow custom filtering and modification of collisions. See [`PhysicsHooks`](crate::rapier::pipeline::PhysicsHooks).
    ...
    ///
    /// Controls whether you receive collision/contact force events. See [`ActiveEvents`](crate::rapier::pipeline::ActiveEvents).
...
impl ColliderBuilder {
    ...
    ///
    /// See [`ActiveHooks`](crate::rapier::pipeline::ActiveHooks) for details on custom collision filtering.
