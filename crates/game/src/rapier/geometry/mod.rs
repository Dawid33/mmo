...
pub use crate::parry::bounding_volume::BoundingVolume;
pub use crate::parry::partitioning::{Bvh, BvhBuildStrategy};
pub use crate::parry::query::{PointQuery, PointQueryWithLocation, RayCast, TrackedContact};
pub use crate::parry::shape::{SharedShape, VoxelState, VoxelType, Voxels};

use crate::rapier::math::{Real, Vector};

/// A contact between two colliders.
pub type Contact = crate::parry::query::TrackedContact<ContactData>;
/// A contact manifold between two colliders.
pub type ContactManifold = crate::parry::query::ContactManifold<ContactManifoldData, ContactData>;
/// A segment shape.
pub type Segment = crate::parry::shape::Segment;
/// A cuboid shape.
pub type Cuboid = crate::parry::shape::Cuboid;
/// A triangle shape.
pub type Triangle = crate::parry::shape::Triangle;
/// A ball shape.
pub type Ball = crate::parry::shape::Ball;
/// A capsule shape.
pub type Capsule = crate::parry::shape::Capsule;
/// A heightfield shape.
pub type HeightField = crate::parry::shape::HeightField;
/// A cylindrical shape.
#[cfg(feature = "dim3")]
pub type Cylinder = crate::parry::shape::Cylinder;
/// A cone shape.
#[cfg(feature = "dim3")]
pub type Cone = crate::parry::shape::Cone;
/// An axis-aligned bounding box.
pub type Aabb = crate::parry::bounding_volume::Aabb;
/// A ray that can be cast against colliders.
pub type Ray = crate::parry::query::Ray;
/// The intersection between a ray and a  collider.
pub type RayIntersection = crate::parry::query::RayIntersection;
/// The projection of a point on a collider.
pub type PointProjection = crate::parry::query::PointProjection;
/// The result of a shape-cast between two shapes.
pub type ShapeCastHit = crate::parry::query::ShapeCastHit;
...
///
/// Receive these through an [`EventHandler`](crate::rapier::pipeline::EventHandler) implementation.
/// At least one collider must have [`ActiveEvents::COLLISION_EVENTS`](crate::rapier::pipeline::ActiveEvents::COLLISION_EVENTS) enabled.
///
/// Use for:
...
pub use crate::parry::shape::*;

#[cfg(feature = "serde-serialize")]
pub(crate) fn default_persistent_query_dispatcher()
-> std::sync::Arc<dyn crate::parry::query::PersistentQueryDispatcher<ContactManifoldData, ContactData>> {
    std::sync::Arc::new(crate::parry::query::DefaultQueryDispatcher)
}
