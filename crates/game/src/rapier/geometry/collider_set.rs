...
use crate::rapier::data::{HasModifiedFlag, ModifiedObjects};
use crate::rapier::dynamics::{IslandManager, RigidBodyHandle, RigidBodySet};
use crate::rapier::geometry::{Collider, ColliderChanges, ColliderHandle, ColliderParent};
use crate::rapier::math::Isometry;
...
impl ColliderSet {
    ...
    /// of [`BroadPhaseBvh::update`](crate::rapier::geometry::BroadPhaseBvh::update).
    ///
    /// Should not be used if this [`ColliderSet`] will be used with a
    /// [`PhysicsPipeline`](crate::rapier::pipeline::PhysicsPipeline), which handles
    ...
    pub fn invalid_handle() -> ColliderHandle {
        ColliderHandle::from_raw_parts(crate::rapier::INVALID_U32, crate::rapier::INVALID_U32)
    }
...
impl Index<crate::rapier::data::Index> for ColliderSet {
    type Output = Collider;

    fn index(&self, index: crate::rapier::data::Index) -> &Collider {
