...
///
/// You typically don't interact with this directly - it's managed by [`PhysicsPipeline`](crate::rapier::pipeline::PhysicsPipeline).
/// However, you can use it to create a [`QueryPipeline`](crate::rapier::pipeline::QueryPipeline) for spatial queries.
