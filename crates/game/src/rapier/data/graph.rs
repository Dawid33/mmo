...
impl NodeIndex {
    ...
    #[inline]
    pub fn end() -> Self {
        NodeIndex(crate::rapier::INVALID_U32)
    }
...
impl EdgeIndex {
    ...
    #[inline]
    pub fn end() -> Self {
        EdgeIndex(crate::rapier::INVALID_U32)
    }
...
impl<N, E> Graph<N, E> {
    ...
    pub fn add_node(&mut self, weight: N) -> NodeIndex {
        ...
        assert!(self.nodes.len() != crate::rapier::INVALID_USIZE);
    ...
    pub fn add_edge(&mut self, a: NodeIndex, b: NodeIndex, weight: E) -> EdgeIndex {
        assert!(self.edges.len() != crate::rapier::INVALID_USIZE);
