...
use crate::rapier::dynamics::solver::{ContactWithCoulombFriction, GenericContactConstraint};
use crate::rapier::math::Real;
use na::DVector;

#[cfg(feature = "dim3")]
use crate::rapier::dynamics::solver::ContactWithTwistFriction;
use crate::rapier::prelude::ContactManifold;
