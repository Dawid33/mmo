use crate::rapier::dynamics::solver::SolverVel;
use crate::rapier::dynamics::solver::contact_constraint::GenericContactConstraint;
use crate::rapier::dynamics::solver::{ContactConstraintNormalPart, ContactConstraintTangentPart};
use crate::rapier::math::{AngVector, DIM, Real, Vector};
use crate::rapier::utils::SimdDot;
use na::DVector;
#[cfg(feature = "dim2")]
use {crate::rapier::utils::SimdBasis, na::SimdPartialOrd};
