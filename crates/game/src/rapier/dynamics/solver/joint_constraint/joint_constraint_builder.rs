...
use crate::rapier::dynamics::solver::joint_constraint::JointSolverBody;
use crate::rapier::dynamics::solver::joint_constraint::joint_velocity_constraint::{
...
use crate::rapier::math::{SIMD_WIDTH, SimdReal};
...
impl<N: SimdRealCopy> JointConstraintHelper<N> {
    ...
    pub fn limit_linear_coupled<const LANES: usize>(
        ...
        let inv_dist = crate::rapier::utils::simd_inv(dist);
        lin_jac *= inv_dist;
        ang_jac1 *= inv_dist;
        ang_jac2 *= inv_dist;
