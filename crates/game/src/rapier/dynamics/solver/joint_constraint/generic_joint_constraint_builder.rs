use crate::rapier::dynamics::solver::MotorParameters;
use crate::rapier::dynamics::solver::joint_constraint::generic_joint_constraint::GenericJointConstraint;
use crate::rapier::dynamics::solver::joint_constraint::joint_velocity_constraint::WritebackId;
...
use crate::rapier::dynamics::solver::ConstraintsCounts;
use crate::rapier::dynamics::solver::solver_body::SolverBodies;
#[cfg(feature = "dim3")]
use crate::rapier::utils::SimdAngularInertia;
#[cfg(feature = "dim2")]
use na::Vector1;
use crate::parry::math::Isometry;
...
impl JointConstraintHelper<Real> {
    ...
    pub fn finalize_generic_constraints(
        ...
        for j in 0..len {
            ...
            let inv_dot_jj = crate::rapier::utils::simd_inv(dot_jj);
