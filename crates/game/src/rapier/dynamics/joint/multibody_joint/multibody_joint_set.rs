...
use crate::rapier::dynamics::{GenericJoint, Multibody, MultibodyJoint, RigidBodyHandle};
use crate::rapier::geometry::{InteractionGraph, RigidBodyGraphIndex};
...
impl Default for MultibodyLinkId {
    fn default() -> Self {
        Self {
            graph_id: RigidBodyGraphIndex::new(crate::rapier::INVALID_U32),
...
impl MultibodyJointSet {
    ...
    pub fn attached_bodies(
        ...
        self.rb2mb
            ...
            .map(move |inter| crate::rapier::utils::select_other((inter.0, inter.1), body))
    }
