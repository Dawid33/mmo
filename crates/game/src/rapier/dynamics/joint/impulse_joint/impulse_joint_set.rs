use crate::parry::utils::hashset::HashSet;
...
#[repr(transparent)]
pub struct ImpulseJointHandle(pub crate::rapier::data::arena::Index);
...
///
/// # Common joint types
/// - [`FixedJoint`](crate::rapier::dynamics::FixedJoint): Weld two bodies together
/// - [`RevoluteJoint`](crate::rapier::dynamics::RevoluteJoint): Hinge (rotation around axis)
/// - [`PrismaticJoint`](crate::rapier::dynamics::PrismaticJoint): Slider (translation along axis)
/// - [`SpringJoint`](crate::rapier::dynamics::SpringJoint): Elastic connection
/// - [`RopeJoint`](crate::rapier::dynamics::RopeJoint): Maximum distance limit
///
/// # Example
/// ```
