use crate::rapier::data::{Arena, HasModifiedFlag, ModifiedObjects};
...
impl Index<crate::rapier::data::Index> for RigidBodySet {
    type Output = RigidBody;

    fn index(&self, index: crate::rapier::data::Index) -> &RigidBody {
        &self.bodies[index]
    }
}
