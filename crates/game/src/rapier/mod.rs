...
macro_rules! enable_flush_to_zero(
    () => {
        let _flush_to_zero = crate::rapier::utils::FlushToZeroDenormalsAreZeroFlags::flush_denormal_to_zero();
    }
);
...
pub mod prelude {
    pub use crate::rapier::dynamics::*;
    pub use crate::rapier::geometry::*;
    pub use crate::rapier::math::*;
    pub use crate::rapier::pipeline::*;
