...
use crate::taffy::geometry::{Line, Point, Rect, Size};
use crate::taffy::style::{AvailableSpace, CoreStyle, LengthPercentageAuto, Overflow, Position};
use crate::taffy::style_helpers::TaffyMaxContent;
use crate::taffy::tree::{
    CollapsibleMarginSet, Layout, LayoutInput, LayoutOutput, RunMode, SizingMode,
};
use crate::taffy::tree::{LayoutPartialTree, LayoutPartialTreeExt, NodeId};
use crate::taffy::util::debug::debug_log;
use crate::taffy::util::sys::f32_max;
use crate::taffy::util::sys::Vec;
use crate::taffy::util::MaybeMath;
use crate::taffy::util::{MaybeResolve, ResolveOrZero};
use crate::taffy::{
    style::BlockContainerStyle, style::BlockItemStyle, style::BoxGenerationMode, style::BoxSizing,
    style::TextAlign, tree::LayoutBlockContainer,
};
...
fn perform_final_layout_on_in_flow_children(
    ...
    for item in items.iter_mut() {
        if item.position == Position::Absolute {
            ...
            let y_margin_offset = if is_collapsing_with_first_margin_set
            ...
            if item_outer_width < container_inner_width {
                match text_align {
                    ...
                    TextAlign::LegacyCenter => {
                        location.x += (container_inner_width - item_outer_width) / 2.0
                    }
                }
            }
