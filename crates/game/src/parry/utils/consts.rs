...
pub(crate) const COS_1_DEGREES: Real = ordered_float::OrderedFloat(0.99984769515);
// pub(crate) const COS_5_DEGREES: Real = 0.99619469809;
pub(crate) const COS_FRAC_PI_8: Real = ordered_float::OrderedFloat(0.92387953251);
#[cfg(feature = "dim2")]
