...
//! ## Fill Modes
//!
//! The [`FillMode`](crate::parry::transformation::voxelization::FillMode) enum controls which voxels are considered "filled":
//!
...
//! # Main Types
//!
//! - [`VoxelSet`](crate::parry::transformation::voxelization::VoxelSet): A sparse set containing only filled voxels (memory-efficient output format)
//! - [`VoxelizedVolume`](crate::parry::transformation::voxelization::VoxelizedVolume): A dense 3D grid of all voxels (intermediate format used during voxelization)
//! - [`Voxel`](crate::parry::transformation::voxelization::Voxel): A single voxel with its grid coordinates and metadata
//! - [`FillMode`](crate::parry::transformation::voxelization::FillMode): Configuration for how to determine filled vs empty voxels
//! - [`VoxelValue`](crate::parry::transformation::voxelization::VoxelValue): The state of a voxel (inside, outside, or on surface)
//!
//! # Examples
//!
...
//! convex decomposition. See the [`vhacd`](crate::parry::transformation::vhacd) module for details.
