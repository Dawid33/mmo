...
//! |------------|---------------|---------|
//! | Already convex | Use [`convex_hull`](crate::parry::transformation::convex_hull) | Box, sphere, simple pyramid |
//! | Simple concave | Use [`Compound`](crate::parry::shape::Compound) of basic shapes | Two boxes in an 'L' shape |
//! | Complex concave | Use convex decomposition | Character mesh, furniture |
//! | Very detailed mesh | Use [`TriMesh`](crate::parry::shape::TriMesh) for static objects | Detailed terrain, static level geometry |
//!
...
//! # See Also
//!
//! - [`VHACDParameters`](crate::parry::transformation::vhacd::VHACDParameters): Configuration parameters for the algorithm
//! - [`VHACD`](crate::parry::transformation::vhacd::VHACD): The main decomposition structure
//! - [`SharedShape::convex_decomposition`](crate::parry::shape::SharedShape::convex_decomposition): High-level API
//! - [`convex_hull`](crate::parry::transformation::convex_hull): For computing convex hulls directly
//! - [`Compound`](crate::parry::shape::Compound): For manually combining convex shapes
