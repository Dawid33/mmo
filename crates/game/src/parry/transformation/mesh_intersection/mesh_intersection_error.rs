use crate::parry::shape::TriMeshBuilderError;

#[cfg(doc)]
use crate::parry::shape::{TriMesh, TriMeshFlags};
...
// /// ```
///
/// [`intersect_meshes`]: crate::parry::transformation::intersect_meshes
/// [`TriMeshFlags::ORIENTED`]: crate::parry::shape::TriMeshFlags::ORIENTED
...
pub enum MeshIntersectionError {
    ...
    ///
    /// [`TriMeshFlags::DELETE_DEGENERATE_TRIANGLES`]: crate::parry::shape::TriMeshFlags::DELETE_DEGENERATE_TRIANGLES
    /// [`intersect_meshes_with_tolerances`]: crate::parry::transformation::intersect_meshes_with_tolerances
