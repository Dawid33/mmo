...
use crate::parry::shape::{CompositeShape, Shape, SharedShape, TypedCompositeShape};
#[cfg(feature = "dim2")]
use crate::parry::shape::{ConvexPolygon, TriMesh, Triangle};
#[cfg(feature = "dim2")]
use crate::parry::transformation::hertel_mehlhorn;
use alloc::vec::Vec;
