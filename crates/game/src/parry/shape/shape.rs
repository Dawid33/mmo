...
use crate::parry::shape::SharedShape;
#[cfg(feature = "alloc")]
use crate::parry::shape::{composite_shape::CompositeShape, Compound, HeightField, Polyline, TriMesh};
...
#[cfg(feature = "dim3")]
use crate::parry::shape::{Cone, Cylinder, RoundCone, RoundCylinder};

#[cfg(feature = "dim3")]
#[cfg(feature = "alloc")]
use crate::parry::shape::{ConvexPolyhedron, RoundConvexPolyhedron, Voxels};

#[cfg(feature = "dim2")]
#[cfg(feature = "alloc")]
use crate::parry::shape::{ConvexPolygon, RoundConvexPolygon, Voxels};
