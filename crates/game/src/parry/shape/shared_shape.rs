...
use crate::parry::math::{Isometry, Point, Real, Vector, DIM};
#[cfg(feature = "dim2")]
use crate::parry::shape::ConvexPolygon;
#[cfg(feature = "serde-serialize")]
use crate::parry::shape::DeserializableTypedShape;
#[cfg(feature = "dim3")]
use crate::parry::shape::HeightFieldFlags;
...
#[cfg(feature = "dim3")]
use crate::parry::shape::{Cone, ConvexPolyhedron, Cylinder};
use crate::parry::transformation::vhacd::{VHACDParameters, VHACD};
use crate::parry::transformation::voxelization::{FillMode, VoxelSet};
use alloc::sync::Arc;
