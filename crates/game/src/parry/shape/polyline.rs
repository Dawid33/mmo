...
use crate::parry::query::{PointProjection, PointQueryWithLocation};
use crate::parry::shape::composite_shape::CompositeShape;
use crate::parry::shape::{FeatureId, Segment, SegmentPointLocation, Shape, TypedCompositeShape};
#[cfg(feature = "alloc")]
use alloc::vec::Vec;
