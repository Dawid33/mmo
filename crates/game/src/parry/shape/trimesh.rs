...
use crate::parry::shape::{FeatureId, Shape, Triangle, TrianglePseudoNormals, TypedCompositeShape};
use crate::parry::utils::HashablePartialEq;
use alloc::{vec, vec::Vec};
use core::fmt;
#[cfg(feature = "dim3")]
use {crate::parry::shape::Cuboid, crate::parry::utils::SortedPair, na::Unit};

use {
    crate::parry::shape::composite_shape::CompositeShape,
    crate::parry::utils::hashmap::{Entry, HashMap},
    crate::parry::utils::hashset::HashSet,
};

#[cfg(feature = "dim2")]
use crate::parry::transformation::ear_clipping::triangulate_ear_clipping;
...
///
/// [`TriMeshFlags::HALF_EDGE_TOPOLOGY`]: crate::parry::shape::TriMeshFlags::HALF_EDGE_TOPOLOGY
...
/// ```
///
/// [`TriMesh`]: crate::parry::shape::TriMesh
/// [`TriMesh::new`]: crate::parry::shape::TriMesh::new
/// [`TriMesh::with_flags`]: crate::parry::shape::TriMesh::with_flags
#[derive(thiserror::Error, Copy, Clone, Debug, PartialEq, Eq)]
        ...
        for t in self.indices.iter() {
            ...
            if !is_degenerate || !delete_degenerate_triangles {
                if delete_duplicate_triangles {
                    let (c, b, a) = crate::parry::utils::sort3(&va, &vb, &vc);
...
#[cfg(feature = "dim3")]
impl From<crate::parry::shape::HeightField> for TriMesh {
    fn from(heightfield: crate::parry::shape::HeightField) -> Self {
