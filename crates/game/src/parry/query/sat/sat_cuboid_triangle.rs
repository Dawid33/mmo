...
#[cfg(feature = "dim2")]
use crate::parry::query::sat::support_map_support_map_compute_separation;
use crate::parry::shape::{Cuboid, SupportMap, Triangle};
...
pub fn cuboid_triangle_find_local_separating_edge_twoway(
    ...
    for (i, axis) in axes.iter().enumerate() {
        ...
        if axis_norm_squared > Real::default_epsilon() {
            ...
            let (dot2_min, dot2_max) = crate::parry::utils::sort2(tri_dots[i].0, tri_dots[i].1);
