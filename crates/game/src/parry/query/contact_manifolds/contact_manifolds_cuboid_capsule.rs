...
use crate::parry::query::{sat, ContactManifold};
#[cfg(feature = "dim3")]
use crate::parry::shape::PolygonalFeature;
use crate::parry::shape::{Capsule, Cuboid, Shape};
#[cfg(feature = "dim2")]
use crate::parry::shape::{CuboidFeature, CuboidFeatureFace};
