...
use crate::parry::query::contact_manifolds::contact_manifolds_workspace::{
    TypedWorkspaceData, WorkspaceData,
};
use crate::parry::query::contact_manifolds::{ContactManifoldsWorkspace, NormalConstraints};
use crate::parry::query::query_dispatcher::PersistentQueryDispatcher;
use crate::parry::query::ContactManifold;
#[cfg(feature = "dim2")]
use crate::parry::shape::Capsule;
use crate::parry::shape::{CompositeShape, HeightField, Shape};
