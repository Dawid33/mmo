...
/// # See Also
///
/// - [`closest_points`](crate::parry::query::closest_points()) - For finding the actual closest points
/// - [`contact`](crate::parry::query::contact()) - For penetration depth when overlapping
/// - [`intersection_test`](crate::parry::query::intersection_test()) - For boolean overlap test
pub fn distance(
    pos1: &Isometry<Real>,
    g1: &dyn Shape,
    pos2: &Isometry<Real>,
