...
/// # See Also
///
/// - [`closest_points`](crate::parry::query::closest_points::closest_points()) - Main function to compute this result
/// - [`distance`](crate::parry::query::distance::distance()) - For just the distance value
/// - [`contact`](crate::parry::query::contact::contact()) - For detailed contact information when intersecting
...
pub enum ClosestPoints {
    ...
    /// are infinitely many contact points. Use [`contact`](crate::parry::query::contact::contact())
