...
use crate::parry::query::{ClosestPoints, DefaultQueryDispatcher, QueryDispatcher, Unsupported};
...
/// | [`distance`](crate::parry::query::distance::distance()) | Distance value | You only need the distance |
/// | [`contact`](crate::parry::query::contact::contact()) | Contact info | Shapes are touching/penetrating |
/// | [`intersection_test`](crate::parry::query::intersection_test::intersection_test()) | Boolean | You only need yes/no overlap |
///
/// # See Also
///
/// - [`ClosestPoints`] - The return type with detailed documentation
/// - [`distance`](crate::parry::query::distance::distance()) - For just the distance value
/// - [`contact`](crate::parry::query::contact::contact()) - For penetration depth and contact normals
/// - [`intersection_test`](crate::parry::query::intersection_test::intersection_test()) - For boolean overlap test
