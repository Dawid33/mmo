...
//!
//! - [`Aabb`](crate::parry::bounding_volume::Aabb) - Axis-aligned bounding boxes
//! - [`Segment`](crate::parry::shape::Segment) - Line segments (in 2D and 3D)
//! - [`TriMesh`](crate::parry::shape::TriMesh) - Triangle meshes (3D only, requires `spade` feature)
//!
//! # Result Types
//!
