...
/// - [`Aabb`](crate::parry::bounding_volume::Aabb) - Axis-aligned bounding box
/// - [`Segment`](crate::parry::shape::Segment) - Line segment
/// - [`TriMesh`](crate::parry::shape::TriMesh) - Triangle mesh
///
...
/// - [`Polyline`](crate::parry::shape::Polyline) - For mesh-plane intersections, representing the
...
pub enum IntersectResult<T> {
    ...
    ///
    /// For triangle meshes, this is typically a [`Polyline`](crate::parry::shape::Polyline) representing
