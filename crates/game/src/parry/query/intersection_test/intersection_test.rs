...
///
/// - Need contact points/normal? → Use [`contact`](crate::parry::query::contact())
/// - Need penetration depth? → Use [`contact`](crate::parry::query::contact())
/// - Need separation distance? → Use [`distance`](crate::parry::query::distance())
/// - Need closest points? → Use [`closest_points`](crate::parry::query::closest_points())
///
/// # See Also
///
/// - [`contact`](crate::parry::query::contact()) - Get contact information if intersecting
/// - [`distance`](crate::parry::query::distance()) - Get separation distance
/// - [`closest_points`](crate::parry::query::closest_points()) - Get closest point locations
