...
#[cfg(feature = "alloc")]
use crate::parry::partitioning::BvhLeafCost;
...
/// # See Also
///
/// - [`cast_shapes_nonlinear`](crate::parry::query::cast_shapes_nonlinear()) - For rotating shapes
/// - [`Ray::cast_ray`](crate::parry::query::RayCast::cast_ray) - For point-like casts
