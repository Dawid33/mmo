...
//! query functions in [`crate::parry::query`] use the [`DefaultQueryDispatcher`](crate::parry::query::DefaultQueryDispatcher) automatically.
//!
...
//!
//! The simplest way is to use the free functions in [`crate::parry::query`], which use the default
...
use crate::parry::query::{ClosestPoints, Contact, NonlinearRigidMotion, ShapeCastHit, Unsupported};
...
/// # See Also
///
/// - [`DefaultQueryDispatcher`](crate::parry::query::DefaultQueryDispatcher): The built-in implementation used by Parry
/// - [`PersistentQueryDispatcher`]: Extended trait for contact manifold queries
/// - [`crate::parry::query`]: High-level query functions that use dispatchers internally
