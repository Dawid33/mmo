...
use crate::parry::shape::{Shape, SupportMap};
use crate::parry::utils::WCross;

use crate::parry::query::gjk::ConstantPoint;
use num::Bounded;
    ...
    SM2: ?Sized + SupportMap,
{
    ...
    let inv_dangvel = crate::parry::utils::inv(dangvel);
    let linear_increment = sum_linear_thickness;
    let angular_increment = Real::pi() - max_angular_thickness;

    let linear_time_increment =
        linear_increment * crate::parry::utils::inv((motion2.linvel - motion1.linvel).norm());
