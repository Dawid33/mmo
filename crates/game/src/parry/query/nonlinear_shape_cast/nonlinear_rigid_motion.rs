use crate::parry::math::{Isometry, Point, Real, Translation, Vector};
...
///
/// This is used with [`cast_shapes_nonlinear`](crate::parry::query::cast_shapes_nonlinear) to perform
...
/// # See Also
///
/// - [`cast_shapes_nonlinear`](crate::parry::query::cast_shapes_nonlinear) - Uses this type for collision detection
/// - [`cast_shapes`](crate::parry::query::cast_shapes) - Linear motion (no rotation)
