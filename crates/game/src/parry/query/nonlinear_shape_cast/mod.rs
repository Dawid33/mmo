...
//!
//! While linear shape casting (see [`cast_shapes`](crate::parry::query::cast_shapes)) handles objects
...
//! # See Also
//!
//! - [`cast_shapes`](crate::parry::query::cast_shapes) - Linear shape casting (translation only)
//! - [`ShapeCastHit`](crate::parry::query::ShapeCastHit) - Result structure with impact information
//! - [`contact`](crate::parry::query::contact::contact()) - Static contact detection (no motion)
