...
use crate::parry::query::gjk::{self, CSOPoint, VoronoiSimplex};
...
use crate::parry::shape::{Capsule, FeatureId, Segment, SupportMap};
#[cfg(feature = "dim3")]
use crate::parry::shape::{Cone, Cylinder};
    ...
    fn cast_local_ray_and_get_normal(
        ...
        #[cfg(feature = "dim2")]
        {
            ...
            if parallel {
                ...
                if dpos.dot(&normal).abs() < crate::parry::math::DEFAULT_EPSILON {
