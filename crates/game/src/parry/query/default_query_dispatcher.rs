...
use crate::parry::shape::{HalfSpace, Segment, Shape, ShapeType};
#[cfg(feature = "alloc")]
use alloc::vec::Vec;
...
/// free functions in the [`crate::parry::query`] module.
///
/// # What It Does
///
...
/// in [`crate::parry::query`] use it automatically:
///
/// ```
...
/// - [`crate::parry::query`]: High-level query functions that use this dispatcher
    ...
    ContactData: Default + Copy,
{
    fn contact_manifolds(
        ...
        use crate::parry::query::contact_manifolds::*;
