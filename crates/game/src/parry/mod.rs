...
pub mod math {
    ...
    pub type AngularInertia<N> = crate::parry::utils::SdpMatrix3<N>;
    ...
    pub type SdpMatrix<N> = crate::parry::utils::SdpMatrix3<N>;
}
...
pub mod math {
    ...
    pub type SdpMatrix<N> = crate::parry::utils::SdpMatrix2<N>;
}
