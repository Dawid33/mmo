...
pub use parry3d::query::{PointQuery, PointQueryWithLocation, RayCast, TrackedContact};
pub use parry3d::shape::{SharedShape, VoxelState, VoxelType, Voxels};

use crate::math::{Real, Vector};

/// A contact between two colliders.
pub type Contact = parry3d::query::TrackedContact<ContactData>;
/// A contact manifold between two colliders.
pub type ContactManifold = parry3d::query::ContactManifold<ContactManifoldData, ContactData>;
/// A segment shape.
pub type Segment = parry3d::shape::Segment;
/// A cuboid shape.
pub type Cuboid = parry3d::shape::Cuboid;
/// A triangle shape.
pub type Triangle = parry3d::shape::Triangle;
/// A ball shape.
pub type Ball = parry3d::shape::Ball;
/// A capsule shape.
pub type Capsule = parry3d::shape::Capsule;
/// A heightfield shape.
pub type HeightField = parry3d::shape::HeightField;
/// A cylindrical shape.
#[cfg(feature = "dim3")]
pub type Cylinder = parry3d::shape::Cylinder;
/// A cone shape.
#[cfg(feature = "dim3")]
pub type Cone = parry3d::shape::Cone;
/// An axis-aligned bounding box.
pub type Aabb = parry3d::bounding_volume::Aabb;
/// A ray that can be cast against colliders.
pub type Ray = parry3d::query::Ray;
/// The intersection between a ray and a  collider.
pub type RayIntersection = parry3d::query::RayIntersection;
/// The projection of a point on a collider.
pub type PointProjection = parry3d::query::PointProjection;
/// The result of a shape-cast between two shapes.
pub type ShapeCastHit = parry3d::query::ShapeCastHit;
...
pub use parry3d::shape::*;

#[cfg(feature = "serde-serialize")]
pub(crate) fn default_persistent_query_dispatcher()
-> std::sync::Arc<dyn parry3d::query::PersistentQueryDispatcher<ContactManifoldData, ContactData>> {
    std::sync::Arc::new(parry3d::query::DefaultQueryDispatcher)
}
