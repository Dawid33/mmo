...
impl Triangle {
    ...
    pub fn normal(&self) -> Option<Unit<Vector<Real>>> {
        Unit::try_new(self.scaled_normal(), Real::from(crate::math::DEFAULT_EPSILON))
    }
    ...
    pub fn is_affinely_dependent(&self) -> bool {
        const EPS: RawReal = crate::math::DEFAULT_EPSILON * 100.0;
    ...
    #[cfg(feature = "dim3")]
    pub fn contains_point(&self, p: &Point<Real>) -> bool {
        const EPS: Real = ordered_float::OrderedFloat(crate::math::DEFAULT_EPSILON);
