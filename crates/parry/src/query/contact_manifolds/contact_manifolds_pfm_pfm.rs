    ...
    ContactData: Default + Copy,
{
    ...
    if manifold.try_update_contacts_eps(pos12, crate::utils::COS_1_DEGREES, Real::from(1.0e-6)) {
        return;
    }

    let init_dir = Unit::try_new(manifold.local_n1, Real::from(crate::math::DEFAULT_EPSILON));
