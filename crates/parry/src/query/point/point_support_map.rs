    ...
    G: SupportMap,
{
    ...
    let dir = Unit::try_new(-m.translation.vector, Real::from(crate::math::DEFAULT_EPSILON))
...
impl PointQuery for ConvexPolyhedron {
    ...
    fn project_local_point_and_get_feature(
        ...
        if let Some(local_dir) = Unit::try_new(local_dir, Real::from(crate::math::DEFAULT_EPSILON)) {
